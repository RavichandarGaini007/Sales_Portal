...
import { Card, CardHeader, CardBody, Row, Col, FormGroup, Label, Select } from 'reactstrap'; // Using reactstrap for layout
              ...
              <li className="nav-item nav-profile dropdown">
                ...
                >
                  ...
                  <div className="nav-profile-text">
                    <p className="text-black font-weight-semibold m-0"> Olson jass </p>
            ...
            <li className="nav-item">
              ...
              <div className="submenu">
                <ul className="submenu-item">
                  <li className="nav-item">
                    <a className="nav-link" href="pages/ui-features/buttons.html">Div+HQ</a>
                  </li>
                  <li className="nav-item">
                    <a className="nav-link" href="pages/ui-features/dropdowns.html">Previous Date Sales Reports</a>
                  </li>
                  <li className="nav-item">
                    <a className="nav-link" href="pages/ui-features/typography.html">Brand+Region+Material</a>
                  </li>
                </ul>
              </div>
            </li>
